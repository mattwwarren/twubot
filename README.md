...
### Running twitch-hubot Locally

You can test your hubot by running the following.

You can start twitch-hubot locally by running:
...
Then you can interact with twitch-hubot by typing `twitch-hubot help`.

    twitch-hubot> twitch-hubot help

    twitch-hubot> animate me <query> - The same thing as `image me`, except adds a few
